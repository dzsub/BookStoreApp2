...
public class EditActivity extends AppCompatActivity implements android.app.LoaderManager.LoaderCallbacks<Cursor> {
    ...
    /**
     * Boolean flag that keeps track of whether the book data has been edited (true) or not (false)
     */
    ...
    /**
     * Get user input from editActivity and save book into database.
     */
    ...
    private void showUnsavedChangesDialog(
        ...
        builder.setMessage(R.string.quit_editing_without_saving);
    ...
    public void dialIntent() {
        ...
        String phoneNumberText = mSupplierPhoneNumberEditText.getText().toString().trim();
        String uri = "tel:" + phoneNumberText;
    ...
    public void increaseQuantityByOne(int one) {
        ...
        mQuantityEditText.setText(String.valueOf(newQuantity + one));
        mBookHasChanged = true;
    }

    public void decreaseQuantityByOne(int one) {
        String currentQuantity = mQuantityEditText.getText().toString();
        int newQuantity;
        if (currentQuantity.equals("0") || currentQuantity.isEmpty()) {
            return;
        } else {
            newQuantity = Integer.parseInt(currentQuantity);
        }
    ...
    private boolean editTextChecker() {
        if (TextUtils.isEmpty(mNameEditText.getText())
                ...
                || TextUtils.isEmpty(mSupplierPhoneNumberEditText.getText())) {
            return false;
        } else {
            return true;
        }
